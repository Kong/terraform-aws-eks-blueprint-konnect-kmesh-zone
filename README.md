...
This EKS Blueprint will create a Kong Mesh Zone in your EKS cluster.

## Helm Chart

### Instructions to use the Helm Chart

See the [Kong Mesh Helm Chart](https://artifacthub.io/packages/helm/kong-mesh/kong-mesh)
...
| <a name="module_kong_mesh_helm"></a> [kong\_mesh\_helm](#module\_kong\_mesh\_helm) | aws-ia/eks-blueprints-addon/aws | 1.1.0 |
...
| [kubernetes_secret.external_secrets](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/secret) | data source |
